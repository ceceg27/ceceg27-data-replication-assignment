...
```{r}
library(curl)
f<- curl ("https://raw.githubusercontent.com/ceceg27/ceceg27-data-replication-assignment/main/ceceg27_edited_data.csv")
d <- read.csv(f, header = TRUE, sep = ",", stringsAsFactors = FALSE)
d
```
...
Now we can get some summary stats for this data 
```{r}
